...
class MockTestWebViewHostApi extends _i1.Mock
  ...
  @override
  String getUrl(int? instanceId) => (super.noSuchMethod(
        Invocation.method(
          #getUrl,
          [instanceId],
        ),
  ...
  @override
  String getTitle(int? instanceId) => (super.noSuchMethod(
        Invocation.method(
          #getTitle,
          [instanceId],
        ),
...
class MockWebView extends _i1.Mock implements _i2.WebView {
  ...
  @override
  _i4.Future<void> setBackgroundColor(_i7.Color? color) => (super.noSuchMethod(
        Invocation.method(
          #setBackgroundColor,
          [color],
        ),
