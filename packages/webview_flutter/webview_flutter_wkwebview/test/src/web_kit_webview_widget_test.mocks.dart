...
class _FakeWKScriptMessageHandler_3 extends _i1.SmartFake
    implements _i2.WKScriptMessageHandler {
  _FakeWKScriptMessageHandler_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeWKUIDelegate_4 extends _i1.SmartFake implements _i2.WKUIDelegate {
  _FakeWKUIDelegate_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockWKWebView extends _i1.Mock implements _i2.WKWebView {
  ...
  @override
  set uiDelegate(_i2.WKUIDelegate? delegate) => super.noSuchMethod(
        Invocation.setter(
          #uiDelegate,
          delegate,
        ),
...
class MockWKWebViewConfiguration extends _i1.Mock
  ...
  @override
  set allowsInlineMediaPlayback(bool? allow) => super.noSuchMethod(
        Invocation.setter(
...
class MockWebViewWidgetProxy extends _i1.Mock
  ...
  @override
  _i2.WKUIDelegate createUIDelgate() => (super.noSuchMethod(
        Invocation.method(
          #createUIDelgate,
          [],
        ),
        returnValue: _FakeWKUIDelegate_4(
          this,
          Invocation.method(
            #createUIDelgate,
            [],
