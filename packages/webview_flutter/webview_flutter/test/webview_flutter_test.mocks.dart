...
class MockWebViewPlatform extends _i1.Mock implements _i4.WebViewPlatform {
  ...
  _i2.Widget build({
    ...
    required _i4.WebViewPlatformCallbacksHandler?
        webViewPlatformCallbacksHandler,
    required _i4.JavascriptChannelRegistry? javascriptChannelRegistry,
    _i4.WebViewPlatformCreatedCallback? onWebViewPlatformCreated,
    Set<_i3.Factory<_i5.OneSequenceGestureRecognizer>>? gestureRecognizers,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #build,
  ...
  @override
  _i6.Future<bool> clearCookies() => (super.noSuchMethod(
        Invocation.method(
          #clearCookies,
          [],
        ),
...
class MockWebViewPlatformController extends _i1.Mock
    implements _i4.WebViewPlatformController {
  MockWebViewPlatformController() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<void> loadFile(String? absoluteFilePath) => (super.noSuchMethod(
        Invocation.method(
          #loadFile,
          [absoluteFilePath],
        ),
  ...
  @override
  _i6.Future<void> loadRequest(_i4.WebViewRequest? request) =>
      (super.noSuchMethod(
        Invocation.method(
          #loadRequest,
          [request],
  ...
  @override
  _i6.Future<void> updateSettings(_i4.WebSettings? setting) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateSettings,
          [setting],
  ...
  @override
  _i6.Future<String?> currentUrl() => (super.noSuchMethod(
        Invocation.method(
          #currentUrl,
          [],
        ),
  ...
  @override
  _i6.Future<String> evaluateJavascript(String? javascript) =>
      (super.noSuchMethod(
        Invocation.method(
          #evaluateJavascript,
          [javascript],
  ...
  @override
  _i6.Future<void> runJavascript(String? javascript) => (super.noSuchMethod(
        Invocation.method(
          #runJavascript,
          [javascript],
        ),
  ...
  @override
  _i6.Future<String> runJavascriptReturningResult(String? javascript) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<void> addJavascriptChannels(Set<String>? javascriptChannelNames) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<void> removeJavascriptChannels(
